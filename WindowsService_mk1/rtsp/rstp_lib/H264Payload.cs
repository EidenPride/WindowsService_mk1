...
namespace Rtsp
{
    ...
    public class H264Payload
    {
        ...
        {
            //TODO - log "RTP Data comprised of " + rtp_payloads.Count + " rtp packets");
            ...
            for (int payload_index = 0; payload_index < rtp_payloads.Count; payload_index++)
            {
                ...
                else if (nal_header_type == 24)
                {
                    ...
                    {
                        //TODO - log "H264 Aggregate Packet processing error");
                    }
                }
                else if (nal_header_type == 25)
                {
                    //TODO - log "Agg STAP-B not supported");
                    stap_b++;
                }
                else if (nal_header_type == 26)
                {
                    //TODO - log "Agg MTAP16 not supported");
                    mtap16++;
                }
                else if (nal_header_type == 27)
                {
                    //TODO - log "Agg MTAP24 not supported");
                    mtap24++;
                }
                else if (nal_header_type == 28)
                {
                    ...
                    //TODO - log "Frag FU-A s=" + fu_header_s + "e=" + fu_header_e);
                ...
                {
                    //TODO - log "Frag FU-B not supported");
                    fu_b++;
                }
                else
                {
                    //TODO - log "Unknown NAL header " + nal_header_type + " not supported");
                }

            }

            // Output some statistics
            //TODO - log "Norm=" + norm + " ST-A=" + stap_a + " ST-B=" + stap_b + " M16=" + mtap16 + " M24=" + mtap24 + " FU-A=" + fu_a + " FU-B=" + fu_b);
