    ...
    public class RtspMessage : RtspChunk
    {
        ...
        public static RtspMessage GetRtspMessage(string aRequestLine)
        {
            ...
            if (requestParts.Length == 3)
            {
                ...
                {
                    //TODO - log _logger.Warn(CultureInfo.InvariantCulture, "Got a strange message {0}", aRequestLine);
        ...
        public void AddHeader(string line)
        {
            ...
            {
                //TODO - log _logger.Warn(CultureInfo.InvariantCulture, "Invalid Header received : -{0}-", line);
            }
        }
